...
public class ListaUsuariosTelaTest {
    ...
    public void listaUsuariosTelaTest() {
        ...
        ViewInteraction textInputEditText2 = onView(
                allOf(childAtPosition(
                        ...
                        0),
                        isDisplayed()));
        textInputEditText2.perform(replaceText("Felipe"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.item_usuario_id_com_nome), withText("(1) Felipe"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText("(1) Felipe")));
    ...
    private void limpaDeDadosInterno() {
